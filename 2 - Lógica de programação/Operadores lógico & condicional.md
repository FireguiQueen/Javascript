...
/* 
Agora, caso o usuário coloque um 'E' em algum dos valores, nosso resultado será 'NaN'. E como estamos em um contexto booleano, o Javascript fará a conversão forçada, e este 'NaN' irá virar um 'false', após isso, temos uma estrutura condincional, que pega este 'false' e transforma em 'true'.
